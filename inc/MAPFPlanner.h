...
public:
    ...
    conflict findCardinalConflicts(const std::vector<std::list<std::pair<int, int>>>& paths, vector<constraint_format> &constraints);
    conflict findConflicts(const std::vector<std::list<std::pair<int, int>>>& paths, vector<constraint_format> &constraints);  
    bool isCardinal(const vector<list<pair<int, int>>>& paths, conflict Conflict, vector<constraint_format> &constraints);
